...
//Lab 4.2
//new HTML button element; deleteButton variable
let deleteButton=document.createElement('button');

//Text on button
deleteButton.textContent='Delete Last Row';

//Click event listener for button. Clicked = deleteLastRow function executes
deleteButton.addEventListener('click', deleteLastRow);

//append buton to document body
...
//Lab 8 4.2
//Function delete last row of table
