...
app.get("/login", function (request, response) {
    ...
    // Generate the HTML for a simple login form
    let login_form = `
        <body>
        <div id="errMsg"></div>
    ...
    // Send the generated login form as the response
...
app.post("/login", function (request, response) {
    ...
    if (!errors) {
        ...
        response.redirect(`./login?error=${response_msg}&username=${submittedUsername}`);
    }
});
